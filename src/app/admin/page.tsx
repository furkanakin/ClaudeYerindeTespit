...
import { MessageSquare, Globe, Users, TrendingUp, Loader2 } from "lucide-react";
...
export default function AdminDashboard() {
    ...
    const stats = [
        { label: "Yeni Başvurular", value: data?.submissions || "0", icon: MessageSquare, color: "bg-blue-500" },
        { label: "Toplam İçerik", value: data?.content || "0", icon: Globe, color: "bg-[#8CC63F]" },
        { label: "Bugünkü Ziyaret", value: data?.visits || "0", icon: TrendingUp, color: "bg-purple-500" },
        { label: "Kullanıcılar", value: data?.users || "1", icon: Users, color: "bg-orange-500" },
    ];
        ...
        <div>
            ...
            {isLoading ? (
                <div className="flex items-center justify-center py-20">
                    <Loader2 className="w-10 h-10 animate-spin text-[#8CC63F]" />
                </div>
            ) : (
