...
export default async function IletisimFormuPage() {
    const submissions = await getContactSubmissions();

    return (
        <div className="p-8">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-[#2C3E50]">İletişim Formu</h1>
                <p className="text-[#6B7280] mt-1">
                    İletişim sayfasından gelen başvurular
                </p>
            </div>
            ...
            {submissions.length === 0 ? (
                <div className="bg-white rounded-xl shadow-sm p-12 text-center border border-gray-100">
                    ...
                    <p className="text-[#6B7280]">Henüz iletişim formu başvurusu bulunmuyor</p>
                </div>
            ) : (
