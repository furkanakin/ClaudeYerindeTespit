...
export const packages: Package[] = [
  {
    ...
    kimlerIcin: [
      '<b>"Bu arsa ya da konut değerlendirmeye değer mi?"</b> sorusuna hızlı yanıt arayanlar',
      "Bir yerin <b>beklentileriyle örtüşüp örtüşmediğini</b> ilk aşamada görmek isteyenler",
      "<b>İlan bilgilerini doğrulayıp</b> temel imar ve riskleri öğrenmek isteyenler",
      "Yerinde inceleme öncesi ölçülü <b>bir ilk değerlendirme</b> isteyenler",
    ],
    forWhom: [
      '<b>"Bu arsa ya da konut değerlendirmeye değer mi?"</b> sorusuna hızlı yanıt arayanlar',
      "Bir yerin <b>beklentileriyle örtüşüp örtüşmediğini</b> ilk aşamada görmek isteyenler",
  ...
  },
  {
    ...
    kimlerIcin: [
      "<b>Alım öncesinde</b> gayrimenkulün <b>gerçek durumunu ayrıntılı olarak öğrenmek isteyenler</b>",
      "İlan bilgileriyle yetinmeyip <b>yerinde tespitlere göre bilinçli karar vermek isteyenler</b>",
      "Gayrimenkulü <b>bizzat görmeye gidemeyen</b>, ancak almayı düşündüğü gayrimenkulün <b>yerinde incelenmesini isteyenler</b>",
      "Yerinde incelemenin <b>bir mimar ve bir mühendis gözüyle</b> yapılmasını önemseyenle",
    ],
    forWhom: [
      "<b>Alım öncesinde</b> gayrimenkulün <b>gerçek durumunu ayrıntılı olarak öğrenmek isteyenler</b>",
      "İlan bilgileriyle yetinmeyip <b>yerinde tespitlere göre bilinçli karar vermek isteyenler</b>",
  ...
  },
  {
    ...
    kimlerIcin: [
      '<b>"Standart paketler benim ihtiyacıma tam uymuyor"</b> diyen ve duruma özel bir çalışma arayanlar',
      "<b>Daha kapsamlı, uzun soluklu veya karmaşık</b> bir karar süreci olanlar (imar değişikliği ihtimali, özel izinler, ileri düzey mimari/teknik görüş gerektiren durumlar gibi)",
      "Mimari ve teknik açıdan <b>daha derinlemesine değerlendirme</b> ihtiyacı olanlar",
      "<b>Birden fazla seçenek arasında karşılaştırmalı ve bütüncül analiz</b> isteyenler",
      "Yerinde Analiz paketinin ötesinde <b>daha detaylı saha çalışması</b> gerektiren durumlar",
      "<b>Yer seçimi konusunda danışmanlık isteyenler</b>",
      "<b>Mimari tasarım ve mühendislik hizmetleri</b> talep edenler",
    ],
    forWhom: [
      '<b>"Standart paketler benim ihtiyacıma tam uymuyor"</b> diyen ve duruma özel bir çalışma arayanlar',
      "<b>Daha kapsamlı, uzun soluklu veya karmaşık</b> bir karar süreci olanlar",
      "Mimari ve teknik açıdan <b>daha derinlemesine değerlendirme</b> ihtiyacı olanlar",
      "<b>Birden fazla seçenek arasında karşılaştırmalı ve bütüncül analiz</b> isteyenler",
      "<b>Yer seçimi konusunda danışmanlık isteyenler</b>",
      "<b>Mimari tasarım ve mühendislik hizmetleri</b> talep edenler",
