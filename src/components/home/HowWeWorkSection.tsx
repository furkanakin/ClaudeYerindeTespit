      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#111827] mb-4">
            Nasıl <span className="text-[#0D9488]">Çalışıyoruz</span>?
          </h2>
        ...
        <div className="relative">
          {/* Connection Line */}
          <div className="hidden lg:block absolute top-24 left-1/2 -translate-x-1/2 w-2/3 h-1 bg-gradient-to-r from-[#0D9488]/20 via-[#0D9488] to-[#0D9488]/20" />
            ...
            {steps.map((item, index) => (
              ...
              >
                ...
                <div className="flex justify-center mb-6">
                  <div className="relative">
                    <div className="w-20 h-20 rounded-full bg-[#0D9488] flex items-center justify-center shadow-lg" style={{ boxShadow: '0 10px 25px rgba(13, 148, 136, 0.3)' }}>
                      <item.icon className="w-8 h-8 text-white" />
                    </div>
                    <span className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-[#111827] text-white text-sm font-bold flex items-center justify-center">
                      {item.step}
                    </span>
                  </div>
                </div>
