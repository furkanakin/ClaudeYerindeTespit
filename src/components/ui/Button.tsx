...
interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: "primary" | "secondary" | "outline" | "ghost" | "lightGreen" | "navy";
  size?: "sm" | "md" | "lg";
}
      ...
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center font-medium transition-all duration-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8CC63F] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed",
          {
            ...
            "bg-[#a3d95b] text-white hover:bg-[#8CC63F] shadow-lg hover:shadow-xl":
              variant === "lightGreen",
            "bg-[#2C3E50] text-white hover:bg-[#1a252f] shadow-lg hover:shadow-xl":
              variant === "navy",
          },
          {
